...
export const KNOWLEDGE_BASE_CHUNKS: KnowledgeChunk[] = [
  {
    ...
    title: "Academy Contact Details & Location",
    category: "contact",
    keywords: ["contact", "phone", "whatsapp", "address", "location", "email", "instagram", "where", "jhanda chichi", "rawalpindi"],
    content: `Mind Flare Academy Contact & Basic Information:
- Academy Name: Mind Flare Academy
- Phone / WhatsApp: 0317-5790206 (WhatsApp link: https://wa.me/923175790206)
- Instagram: @mind_flare_academy
...
Mind Flare Academy is a premier academic educational institute in Rawalpindi offering comprehensive coaching from Nursery to Class 12 (Matric & Intermediate all groups) and Bachelor's level subject support.`
  },
  {
    ...
    section: "1. About Mind Flare Academy",
    title: "Mission, Vision & Why Choose Us",
    category: "about",
...
- Small batch sizes for focused, personalized attention.
...
- Clean, safe, and disciplined academy environment.`
  ...
  {
    id: "kb-classes-primary-middle",
    section: "2. Programs & Classes Offered (Pre-Primary to Middle)",
    title: "Pre-Primary, Primary and Middle Classes (Nursery to Class 8)",
    category: "classes",
    keywords: ["primary", "nursery", "prep", "play group", "class 1", "class 2", "class 3", "class 4", "class 5", "class 6", "class 7", "class 8", "middle"],
    content: `Programs & Classes:
2.1 Pre-Primary & Primary Section (Nursery to Class 5):
- Nursery / Play Group & Prep (Montessori-based early learning)
- Class 1 to Class 5 (all subjects: English, Urdu, Math, Science, Islamiyat, Social Studies, General Knowledge)
- Focus: building strong reading, writing, numeracy skills, handwriting improvement, spoken English basics, and moral/Islamic values.

2.2 Middle Section (Class 6 to Class 8):
- All core subjects: English, Urdu, Mathematics, Science (General Science), Islamiyat, Pakistan Studies / Social Studies, Computer Science.
- Focus: exam techniques, concept building in Math and Science, and preparing foundation for Matric.`
  },
  {
    id: "kb-classes-matric-inter",
    section: "2. Programs & Classes Offered (Matric & Intermediate)",
    title: "Matric (Class 9-10) and Intermediate (Class 11-12) Groups",
    category: "classes",
    keywords: ["matric", "class 9", "class 10", "inter", "intermediate", "class 11", "class 12", "fsc", "pre-medical", "pre-engineering", "ics", "commerce", "arts", "bise rawalpindi"],
    content: `2.3 Matric Section (Class 9 & Class 10):
- Science Group (Pre-Medical & Pre-Engineering): Physics, Chemistry, Biology, Mathematics, English, Urdu, Islamiyat, Pakistan Studies, Computer Science.
- Arts / General Group: English, Urdu, Islamiyat, Pakistan Studies, General Math, Home Economics / Civics / Geography.
- BISE Rawalpindi pattern preparation with regular tests, past-paper practice, and solved guess papers.

2.4 Intermediate Section (Class 11 & Class 12):
...
- Biology: Class 9: PKR 2,300/mo | Class 10: PKR 2,500/mo
- Mathematics: Class 9: PKR 2,300/mo | Class 10: PKR 2,500/mo
- Computer Science: Class 9: PKR 2,000/mo | Class 10: PKR 2,200/mo
- English: Class 9: PKR 1,800/mo | Class 10: PKR 2,000/mo
- Urdu: Class 9: PKR 1,600/mo | Class 10: PKR 1,800/mo
- Islamiyat: Class 9: PKR 1,300/mo | Class 10: PKR 1,500/mo
- Pakistan Studies / Social Studies: Class 9: PKR 1,300/mo | Class 10: PKR 1,500/mo

Discounted Full Package Deals:
- Full Science Group (Physics, Chemistry, Biology/CS, Math, English, Urdu, Islamiyat, Pak Studies):
  Class 9: PKR 7,500 / month | Class 10: PKR 8,000 / month
- Full Arts / General Group (All subjects combined):
  Class 9: PKR 6,000 / month | Class 10: PKR 6,500 / month`
  },
  {
...
- Biology: Class 11: PKR 2,800/mo | Class 12: PKR 3,000/mo
- Mathematics: Class 11: PKR 2,800/mo | Class 12: PKR 3,000/mo
- Computer Science: Class 11: PKR 2,500/mo | Class 12: PKR 2,800/mo
- Statistics: Class 11: PKR 2,300/mo | Class 12: PKR 2,500/mo
- Economics / Principles of Accounting / Business Studies: Class 11: PKR 2,300/mo | Class 12: PKR 2,500/mo
- English: Class 11: PKR 2,300/mo | Class 12: PKR 2,500/mo
- Urdu: Class 11: PKR 1,800/mo | Class 12: PKR 2,000/mo
- Islamiyat: Class 11: PKR 1,600/mo | Class 12: PKR 1,800/mo
- Pakistan Studies: Class 11: PKR 1,600/mo | Class 12: PKR 1,800/mo

Discounted Group Packages:
- Pre-Medical Group (Physics, Chem, Bio, Eng, Urdu): Class 11: PKR 9,500/mo | Class 12: PKR 10,000/mo
- Pre-Engineering Group (Physics, Chem, Math, Eng, Urdu): Class 11: PKR 9,500/mo | Class 12: PKR 10,000/mo
- ICS Group (Physics/Stats, Math, CS, Eng, Urdu): Class 11: PKR 9,000/mo | Class 12: PKR 9,500/mo
- Commerce Group (Accounting, Business Studies, Economics, Stats, Eng, Urdu): Class 11: PKR 8,500/mo | Class 12: PKR 9,000/mo
...
- Policy: Fees are due by the 10th of every month. Fee once paid is non-refundable but adjustable against the next month in genuine cases.`
  },
  {
    ...
    content: `Admission Process (Simple & Quick):
- Step 1: Visit academy at House DD1, Street # 6, Jhanda Chichi, Rawalpindi, or WhatsApp/call at 0317-5790206 or email mindflareacademy@gmail.com.
...
- Strict discipline and zero-tolerance anti-bullying policy

Faculty:
Taught by qualified subject specialists with Master's degrees or higher and extensive experience in Rawalpindi/Islamabad schools and colleges.

Academy Rules & Policies:
- Minimum 80% attendance is required to sit in monthly tests and receive result cards.
- Students must carry their academy ID card and notebooks to every class.
- Fee must be paid by the 10th of each month (PKR 200/week late surcharge after 10th).
- Three consecutive unpaid months may result in suspension of classes.
- Respectful behavior is mandatory; mobile phones must be kept on silent/switched off during class hours.
- Leave applications for extended absence should be submitted in advance.`
  },
  {
    id: "kb-faqs",
...
A: Call or WhatsApp: 0317-5790206, Instagram: @mind_flare_academy, Email: mindflareacademy@gmail.com.

Q: What are the shift timings?
A: Morning Shift (8:00 AM – 12:00 PM) and Evening Shift (3:00 PM – 7:00 PM), each 4 hours.

Q: What is the fee for Matric (Class 10) subjects?
A: Subject-wise fees range from PKR 1,500 to PKR 2,500 per month. Full Science Group is PKR 8,000/month, and Full Arts/General Group is PKR 6,500/month.
...
A: Yes, 10% tuition discount from the 2nd sibling onward.

Q: What documents are needed for admission?
A: Copy of latest result/mark sheet (for Class 6+), 1 passport photograph, and completed admission form.`
  }
];

/**
 * Intelligent in-memory similarity & keyword search for RAG retrieval
 */
export function retrieveRelevantChunks(query: string, topK: number = 3): KnowledgeChunk[] {
  ...
  const scoredChunks = KNOWLEDGE_BASE_CHUNKS.map((chunk) => {
    ...
    queryTerms.forEach((term) => {
      // Direct keyword match in tags (highest weight)
      ...
      // Match in content
      const occurrences = (chunkContent.match(new RegExp(term, "g")) || []).length;
      score += Math.min(occurrences * 2, 10);
    });

    // Special intent boosts
    if (normalizedQuery.includes("fee") || normalizedQuery.includes("cost") || normalizedQuery.includes("price") || normalizedQuery.includes("pkr")) {
      if (chunk.category === "fees") score += 10;
    }
    if (normalizedQuery.includes("where") || normalizedQuery.includes("location") || normalizedQuery.includes("contact") || normalizedQuery.includes("address") || normalizedQuery.includes("number") || normalizedQuery.includes("whatsapp")) {
      if (chunk.category === "contact") score += 12;
    }
    if (normalizedQuery.includes("time") || normalizedQuery.includes("shift") || normalizedQuery.includes("hours") || normalizedQuery.includes("when")) {
      if (chunk.category === "timings") score += 12;
    }
